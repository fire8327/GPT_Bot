...
def get_system_prompt(mode: str) -> str:
    prompts = {
        "school": (
            ...
            "НЕ ИСПОЛЬЗУЙ и НЕ УПОМИНАЙ: тригонометрию, синусы/косинусы, логарифмы, "
            "экспоненты, показательные функции, дифференцирование, интегралы, производные. "
        ...
        "work": (
            ...
            "Форматируй ответы так, чтобы их можно было сразу копировать в Word. "
            "Отвечай на русском языке."
        ),
        "free": (
        ...
        "summary": (
            ...
            "ключевые тезисы, основные выводы, важные детали. "
    ...
    return prompts.get(mode, "Ты — полезный AI-ассистент. Отвечай на русском языке.")
